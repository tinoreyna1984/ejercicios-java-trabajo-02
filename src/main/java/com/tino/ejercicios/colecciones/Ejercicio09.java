...
/**
 * Escribe un programa que busque un elemento específico en una lista
 * y, si se encuentra, imprima su posición en la lista.
 */
// Producto se importa desde Ejercicio08
public class Ejercicio09 {
    public static void main(String[] args) {
        ...
        listaProd.add(p11);
        listaProd.add(p12);
        Producto prodEspecifico = listaProd.stream() // genera stream
