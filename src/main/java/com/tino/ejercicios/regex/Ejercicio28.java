...
/**
 * Verifica si un fragmento de HTML contiene etiquetas
 * HTML correctamente equilibradas. Esto significa que
 * cada etiqueta de apertura tiene una etiqueta de cierre correspondiente.
 */
